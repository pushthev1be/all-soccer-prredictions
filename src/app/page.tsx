        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            return (
              <div
                key={i}
                className="group p-6 rounded-xl bg-white/60 backdrop-blur-lg border-2 border-white/30 shadow-lg hover:bg-white/75 hover:border-blue-400/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
